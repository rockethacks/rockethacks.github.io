...
const collegeSchedule = [
  { day: "Day 1", time: "08:30 AM", event: "Hackers Check-in", venue: "Outside Nitschke Auditorium" },
  { day: "Day 1", time: "09:00 AM", event: "Opening Ceremony", venue: "Nitschke Auditorium" },
  { day: "Day 1", time: "10:00 AM", event: "Team Formation", venue: "Nitschke Auditorium" },
  { day: "Day 1", time: "11:00 AM", event: "Hacking Starts!", venue: "Nitschke Hallway" },
  ...
  { day: "Day 2", time: "11:00 AM", event: "Project Submissions Due", venue: "Nitschke Hallway" },
  ...
  { day: "Day 2", time: "1:30 PM", event: "Closing Ceremony & Awards", venue: "Nitschke Auditorium" },
];

const highSchoolSchedule = [
  { day: "Day 1", time: "08:00 AM", event: "Hackers Check-in", venue: "Outside Nitschke Auditorium" },
  { day: "Day 1", time: "09:00 AM", event: "Opening Ceremony", venue: "Nitschke Auditorium" },
  { day: "Day 1", time: "10:00 AM", event: "Campus Tour", venue: "University Of Toledo" },
  { day: "Day 1", time: "11:00 AM", event: "KoolKat Science Workshop", venue: "North Engineering 2100" },
  { day: "Day 1", time: "12:00 PM", event: "Project on Scratch", venue: "North Engineering 2100" },
  { day: "Day 1", time: "02:00 PM", event: "Judging", venue: "North Engineering 2100" },
];
...
export default function Schedule() {
  ...
  const filteredCollegeSchedule = collegeSchedule.filter(item => item.day === selectedCollegeDay);
          ...
          <div className={`${terminal.className} text-white w-full md:w-1/2 bg-slate-950/30 backdrop-blur-sm border-blue-600 border-2 rounded-md p-5`}>
            ...
            <Tabs.Root defaultValue="college" onValueChange={setSelectedTab}>
              <Tabs.List className="flex justify-center space-x-4 mb-4 border-b border-gray-500">
                <Tabs.Trigger
                  value="college"
                  className={`px-6 py-3 text-2xl md:text-3xl font-bold border-b-2 ${selectedTab === "college" ? "border-yellow-400" : "border-transparent"} transition`}
                >
                  College
                </Tabs.Trigger>
                <Tabs.Trigger
                  value="highschool"
                  className={`px-6 py-3 text-2xl md:text-3xl font-bold border-b-2 ${selectedTab === "highschool" ? "border-yellow-400" : "border-transparent"} transition`}
                >
                  High School
                </Tabs.Trigger>
              </Tabs.List>
                    ...
                    >
                      <div className="flex justify-center space-x-4 mb-4">
                        <button
                          ...
                          className={`px-4 py-2 rounded ${selectedCollegeDay === "Day 1" ? "bg-yellow-400 text-black" : "bg-transparent border border-white text-white"} transition`}
                        >
                          Day 1
                        </button>
                        <button
                          onClick={() => setSelectedCollegeDay("Day 2")}
                          className={`px-4 py-2 rounded ${selectedCollegeDay === "Day 2" ? "bg-yellow-400 text-black" : "bg-transparent border border-white text-white"} transition`}
                        >
                          Day 2
                        </button>
                      </div>
                      <Accordion type="single" collapsible>
                        {filteredCollegeSchedule.map((item, index) => (
                          <AccordionItem key={index} value={`college-${selectedCollegeDay}-${index}`}>
